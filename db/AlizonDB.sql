...
CREATE TABLE _sous_categorie (
    ...
    constraint _Sous_Categorie_Categorie foreign key (Id_Categorie_Sup) references _categorie (ID_Categorie)
);
...
CREATE TABLE _produit (
    ...
    CONSTRAINT _produit_Sous_Categorie_fk FOREIGN KEY (Id_Sous_Categorie) REFERENCES _sous_categorie (Id_Sous_Categorie)
);
...
CREATE TABLE _adresse (
    ...
    constraint _Adresse_Client_fk foreign key (ID_Client) references _client (ID_Client)
);
...
CREATE TABLE _panier (
    ...
    constraint _Panier_Client_fk foreign key (ID_Client) references _client (ID_Client)
);
...
CREATE TABLE _commande (
    ...
    constraint _Commande_Client_fk foreign key (ID_Client) references _client (ID_Client)
);
...
CREATE TABLE _contient_produit_p (
    ...
    constraint _contient_produit_p_Panier_fk foreign key (ID_Panier) references _panier (ID_Panier) ON DELETE CASCADE, -- ON DELETE CASCADE delete les contitent produit d'un panier si le panier est delete
    constraint _contient_produit_p_produit_fk foreign key (ID_produit) references _produit (ID_produit)
);
...
CREATE TABLE _contient_produit_c (
    ...
    constraint _contient_produit_c_Commande_fk foreign key (ID_Commande) references _commande (ID_Commande),
    constraint _contient_produit_c_produit_fk foreign key (ID_produit) references _produit (ID_produit)
);
...
CREATE TABLE _avis (
    ...
    constraint _avis_produit_fk foreign key (ID_produit) references _produit (ID_produit),
    constraint _avis_Client_fk foreign key (ID_Client) references _client (ID_Client)
);
...
CREATE TABLE _reponse (
    ...
    constraint _reponse_avis_fk foreign key (ID_Commentaire) references _avis (ID_Commentaire),
    constraint _reponse_Client_fk foreign key (ID_Vendeur) references _vendeur (ID_Vendeur)
);
...
CREATE TABLE _paiement (
    ...
    constraint _paiement_Commande_fk foreign key (ID_Commande) references _commande (ID_Commande),
    constraint _paiement_Client_fk foreign key (ID_Client) references _client (ID_Client)
);
...
CREATE TABLE _signaler (
    ...
    constraint _Posteur_fk foreign key (ID_Commentaire) references _avis (ID_Commentaire) ON DELETE CASCADE,
    constraint _Signaleur_fk foreign key (ID_Signaleur) references _client (ID_Client)
);
...
SELECT
    ...
    images2,
    images3,
    _contient_produit_p.id_produit,
    nom_categorie,
    quantite_disponnible,
    quantite,
    prix_total_ttc,
    prix_produit_commande_ttc,
    Nom_vendeur as vendeur,
    description_produit,
    _panier.id_panier,
    prix_vente_ttc,
    _sous_categorie.nom as nom_SouCategorie
FROM
    _contient_produit_p
...
values (
        ...
        'FR59542051180',
        '542051180',
        '277 474 277 605 426 312 407 268 442 605 117 426 23 471 474 442',
        'img1',
        'TOTAL est la 4ème compagnie de denrée alimentaire Bretonne (sur la base de la capitalisation boursière). aval ( trading et transport maritime de produits alimentaires et de produits agricoles, distribution).',
        'Totale est une entreprise Bretonne totalement écologique, qui cultivie des produits BIO sans pesticide'
    );
...
values (
        ...
        'FR34489786343',
        '489786343',
        '605 426 224 117 384 384 312 407 268 442 605 117 426 23 471 474 442',
        'img1',
        'Notre entreprise Alpine, appelée "Alpes Gourmandes", est spécialisée dans la vente de produits alimentaires de qualité issus de la région alpine. Nous travaillons en étroite collaboration avec des producteurs locaux pour offrir à nos clients des produits frais, savoureux et écologique',
        'Alpine est une entreprise dynamique qui se dévoue à fournir des produits alimentaires de qualité supérieure à ses clients. En se concentrant sur les ingrédients locaux, Alpine offre des produits frais et de saison qui répondent aux normes les plus élevées en matière de qualité et de durabilité.'
    );
...
values (
        ...
        'FR31784939688',
        '784939688',
        ' 224 117 471 605 407 268 442 605 117 426 23 471 474 442',
        'img1',
        'Picard est une entreprise bien établie dans le domaine des produits surgelés, qui se distingue par son large choix de produits de qualité. Avec plus de 1 000 produits différents, Picard offre une variété de plats, de desserts et de collations pour répondre aux besoins de ses clients.',
        'Picard est une entreprise qui se dévoue à fournir des produits de qualité exceptionnelle à ses clients. Grâce à sa large sélection de produits,picardddd offre une grande variété de denrée pour tous les goûts et tous les besoins.'
    );
...
values (
        ...
        'LuisPasViton',
        'lVP@gmail.com',
        'Zone industrielle des peupliers',
        'Batiment D',
        'Marseille',
        13000,
        'FR15347662454',
        '347662454',
        '426 189 567 407 268 442 605 117 426 23 471 474 442',
        'img1',
        'LuisPasViton est une entreprise renommée dans le domaine alimentaire, qui se dévoue à fournir des produits de qualité exceptionnelle à ses clients. Grâce à leur expertise en matière de luxe, Louis Vuitton offre une gamme de produits culinaires haut de gamme, qui allient qualité et raffinement.',
        'LuisPasViton est une entreprise qui se dévoue à fournir une expérience gastronomique de luxe à ses clients. Grâce à leur savoir-faire et leur engagement envers la qualité, ils proposent une gamme de produits alimentaires haut de gamme qui allient saveurs raffinées et ingrédients de qualité exceptionnelle.'
    );
...
VALUES (
        ...
        '2003-12-15',
        'paprika@gmail.com',
        '224 605 224 321 117 19 605 407 268 442 605 117 426 23 471 474 442',
        'Gardeur'
    );
...
VALUES (
        ...
        'Laughren',
        '2002-05-24',
        'TitouanRobe@gmail.com',
        '548 117 277 474 3 605 384 669 474 501 312 407 268 442 605 117 426 23 471 474 442',
        'Rennes'
    );
...
VALUES (
        ...
        'Theo',
        '2003-10-01',
        'TheoDemany@gmail.com',
        '548 261 312 474 68 312 442 605 384 386 407 268 442 605 117 426 23 471 474 442',
        'Audi'
    );
...
INSERT INTO
    _sous_categorie (id_categorie_sup, nom, tva)
VALUES (1, 'Gateaux', 0.10);

INSERT INTO
    _sous_categorie (id_categorie_sup, nom, tva)
VALUES (1, 'Déjeuner', 0.10);
...
INSERT INTO
    _sous_categorie (id_categorie_sup, nom, tva)
VALUES (3, 'Vêtements de pluie', 0.20);

INSERT INTO
    _sous_categorie (id_categorie_sup, nom, tva)
VALUES (3, 'Accessoires', 0.20);
...
INSERT INTO
    _sous_categorie (id_categorie_sup, nom, tva)
VALUES (4, 'Cartes postales', 0.20);

INSERT INTO
    _sous_categorie (id_categorie_sup, nom, tva)
VALUES (4, 'Portes clefs', 0.20);

INSERT INTO
    _sous_categorie (id_categorie_sup, nom, tva)
VALUES (5, 'Poissons', 0.0550);

INSERT INTO
    _sous_categorie (id_categorie_sup, nom, tva)
VALUES (5, 'Viande', 0.0550);
...
VALUES (
        ...
        "10.20",
        71,
        "Le véritable kouign-amann breton, croustillant à l'extérieur et fondant à l'intérieur, préparé avec du beurre AOP et une touche de sucre caramélisé.",
        "img1.jpg",
        "img2.jpg",
        "img3.jpg",
        5,
    ...
    (
        ...
        "5.40",
        35,
        "Un gâteau moelleux et généreux, fait à parts égales de beurre, sucre, farine et œufs pour une texture authentique et savoureuse.",
        "img1.jpg",
        "img2.jpg",
        NULL,
        5,
    ...
    (
        "Miel Breton toutes fleurs",
        "7.00",
        "12.00",
        "13.50",
        120,
        "Miel artisanal de Bretagne, récolté avec soin par des apiculteurs locaux. Texture onctueuse et arômes floraux riches.",
        "img1.jpg",
        "img2.jpg",
        "img3.jpg",
        NULL,
    ...
    (
        ...
        "4.20",
        55,
        "Beurre demi-sel fermier au goût authentique, idéal pour accompagner vos tartines ou pour la cuisine.",
        "img1.jpg",
        "img2.jpg",
        "img3.jpg",
        NULL,
    ...
    (
        ...
        "7.80",
        90,
        "Caramel artisanal au beurre salé, crémeux et riche en goût. Parfait pour les crêpes, glaces ou à déguster à la cuillère !",
        "img1.jpg",
        "img2.jpg",
        NULL,
        NULL,
    ...
    (
        "Crêpe Dentelle cœur cacao noisette",
        "1.50",
        "3.00",
        "3.60",
        148,
        "Fine et croustillante, cette crêpe dentelle renferme un délicieux cœur fondant au cacao et aux noisettes.",
        "img1.jpg",
        "img2.jpg",
        "img3.jpg",
        NULL,
    ...
    (
        "Cola bien frais - 2,5L",
        "1.50",
        "2.99",
        "3.59",
        380,
        "Une boisson gazeuse rafraîchissante au goût intense, idéale pour accompagner vos repas et moments de détente.",
        "img1.jpg",
        "img2.jpg",
        "img3.jpg",
        NULL,
    ...
    (
        ...
        "1.44",
        210,
        "Thé glacé naturel à la pêche, avec une infusion authentique de thé noir pour une saveur rafraîchissante.",
        "img1.jfif",
        NULL,
        NULL,
        NULL,
    ...
    (
        ...
        "1.68",
        126,
        "Boisson pétillante aux agrumes avec des fines bulles et un goût délicatement fruité.",
        "img1.jpg",
        NULL,
        NULL,
        NULL,
    ...
    (
        ...
        "1.32",
        367,
        "Cola breton original, à la recette unique pour un goût authentique et rafraîchissant.",
        "img1.jfif",
        NULL,
        NULL,
        NULL,
    ...
    (
        ...
        "1.19",
        94,
        "Limonade bretonne artisanale, au goût frais et légèrement acidulé.",
        "img1.webp",
        NULL,
        NULL,
        NULL,
    ...
    (
        "Jus de Pomme Tradition - 1,6L",
        "1.80",
        "3.80",
        "4.56",
        80,
        "Jus de pomme pur, issu de vergers bretons. Pressé à froid pour conserver toutes ses saveurs.",
        "img1.jpg",
        NULL,
        NULL,
        NULL,
    ...
    (
        "Jus de Pommes qui pétille - 75cl",
        "1.50",
        "3.50",
        "4.20",
        46,
        "Jus de pommes pétillant, parfait pour célébrer les petites et grandes occasions !",
        "img1.jpg",
        "img2.jpg",
        NULL,
        NULL,
    ...
    (
        "Liqueur de fraise de Plougastel - 70cl",
        "12.00",
        "18.50",
        "22.20",
        24,
        "Liqueur artisanale aux fraises de Plougastel, une explosion de saveurs fruitées et sucrées.",
        "img1.jpg",
        NULL,
        NULL,
        NULL,
    ...
    (
        ...
        "40.80",
        28,
        "Whisky breton équilibré, entre malt et grain, vieilli en fûts de chêne pour une saveur unique.",
        "img1.jpg",
        "img2.jpg",
        "img3.jpg",
        NULL,
    ...
    (
        "Armorik Tradition BIO - 70cl",
        "28.00",
        "42.00",
        "50.40",
        17,
        "Whisky breton bio, aux notes fruitées et épicées, élaboré avec du malt issu de l'agriculture biologique.",
        "img1.jpg",
        "img2.jpg",
        "img3.jpg",
        NULL,
    ...
    (
        ...
        "21.60",
        89,
        "Bottes en caoutchouc robustes et imperméables, idéales pour affronter la pluie bretonne.",
        "img1.jpg",
        "img2.jpg",
        NULL,
        NULL,
    ...
    (
        "Bob circuit Paul Ricard",
        "12.00",
        "20.00",
        "24.00",
        0,
        "Bob officiel du circuit Paul Ricard, idéal pour se protéger du soleil lors des événements automobiles.",
        "img1.jpg",
        "img2.jpg",
        NULL,
        NULL,
    ...
    (
        "Bolée triskell marron sans anse",
        "3.50",
        "6.00",
        "7.20",
        45,
        "Bolée traditionnelle en grès, parfaite pour déguster du cidre.",
        "img1.jpg",
        "img2.jpg",
        NULL,
        NULL,
    ...
    (
        "Bolée sans anse 'Poisson noir'",
        "3.50",
        "6.00",
        "7.20",
        68,
        "Bolée artisanale en grès, au décor poisson noir, idéale pour les amateurs de cidre.",
        "img1.jpg",
        "img2.jpg",
        NULL,
        NULL,
    ...
    (
        ...
        "3.00",
        100,
        "Porte-clé en métal avec motif triskell, symbole emblématique de la Bretagne.",
        "img1.jpg",
        NULL,
        NULL,
        NULL,
    ...
    (
        "Maquereau, poivron jaune et piment d'Espelette",
        "5.00",
        "8.50",
        "10.20",
        350,
        "Maquereau breton aux saveurs relevées, préparé avec du poivron jaune et du piment d'Espelette.",
        "img1.jpg",
        "img2.jpg",
        NULL,
        NULL,
    ...
    (
        ...
        "144.00",
        50,
        "Montre élégante avec motif hermine bretonne, alliant tradition et modernité.",
        "img1.jpg",
        NULL,
        NULL,
        NULL,
...
INSERT INTO
    _commande (
        ID_Client,
        nom_de_rue_livraison,
        complement_livraison,
        ville_livraison,
        code_postale_livraison,
        nom_de_rue_facturation,
        complement_facturation,
        ville_facturation,
...
VALUES (
        ...
        '1',
        '5',
        'Très bon produit, le prix est pas très élevé pas sa qualité',
        NULL
    );
...
VALUES (
        ...
        '1',
        '4',
        'Très apprécié ce produit qui me fait ravivé les papilles !',
        NULL
    );
...
VALUES (
        ...
        '6',
        '2',
        'Pas aimé du tous ! Trop chère pour la qualité, et il y avait trop de chocolat',
        NULL
    );
...
VALUES (
        ...
        '2',
        '3',
        'Moyen, je ne pense pas racheter ce produit car ça ne ma pas fait réver',
        NULL
    );
...
VALUES (
        ...
        '6',
        '4',
        'Bien aimé, le chocolat est onctueux, et la pate crocante !',
        NULL
    );
...
VALUES (
        ...
        '1',
        '5',
        'Parfait ! La livraison était rapide, et le produit était comme la photo',
        NULL
    );
