...
<body>
    ...
    <main class="paiement">
        ...
        <div class="carte_paiement">
                ...
                <article class="carte_livraison">
                    ...
                    <div class="carte_livraison_chooseAdresse">
                        ...
                        <select name="adress" id="adressFacturation-select">
                            ...
                            <?php $i = 1;
                            foreach ($listeAdresseFacturation as $key => $adr):
                                if ($adr['complement'] != '') {
                    ...
                    <div class="carte_livraison_chooseAdresse">
                        ...
                        <select name="adress" id="adressLivraison-select">
                            ...
                            <?php $i = 1;
                            foreach ($listeAdresse as $key => $adr):
                                if ($adr['complement'] != '') {
                                    $adresse = $adr['nom_de_rue'] . " " . $adr['complement'] . " " . $adr['code_postale'] . " " . $adr['ville'];
                                } else {
                                    $adresse = $adr['nom_de_rue'] . " " . $adr['code_postale'] . " " . $adr['ville'];
                            ...
                            <form method="post" onsubmit="return VerificationCarteBleu();">
                                <div class="ligne">
                                    <div class="col-50">
                                        ...
                                        <label for="ccnum">Numéro de carte de crédit <i id="TypeCbPayement"
                                                class=""></i></label>
            ...
            <aside class="carte_commande">
                ...
                <aside>
                    En passant votre commande, Vous acceptez les <a href="#">Conditions générales de ventes</a> de
                    alizon.
                </aside>
            </aside>
        </div>
    ...
    <footer>
        ...
        <script>
            ...
            let AdresseFacturation_Commande = document.querySelector("input[name='ID_AdresseFacturation_Commande']");
            let AdresseLivraison_Commande = document.querySelector("input[name='ID_AdresseLivraison_Commande']");
            let adressFacturation_Select = document.getElementById("adressFacturation-select");
            let adressLivraison_Select = document.getElementById("adressLivraison-select");
            ...
            /**######################################## CARTE BANCAIRE ########################################**/
            // RECUPERATION DES ELEMENTS HTML
            let btnCB = document.querySelector(".btn-cb");
            let blocPaiement = document.querySelector(".CarteBancaire");
            let CroixPaiement = document.querySelector(".fermer-blocCB");
