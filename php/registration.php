...
<body>
    ...
    <main class="main-inscription">
        ...
        <form class="form-inscription" action="functions/form/registration.inc.php" method="post">
            ...
            <div class="formulaire">
                ...
                <div class="identifiants">
                    ...
                    <div class="bloc-email">
                        ...
                        <input class="champ_mail" type="email" name="email" value="<?php
                    ...
                    <div class="bloc-mdp">
                        ...
                        <input class="champ_mdp" type="password" name="mdp" minlength="8" value="<?php
                    ...
                    <div class="bloc-cmdp">
                        ...
                        <input class="champ_mdp_conf" type="password" name="cmdp" minlength="8" value="<?php
                    ...
                    <script>
                        ...
                        function afficheSiDifférent() {
                            ...
                            if ((mdp.value != cmdp.value) && (mdp.value != "") && (cmdp.value != "") && (cmdp.value
                                    .length >= mdp.value.length)) {
                        ...
                        let mdp = document.getElementsByClassName("champ_mdp")[0];
                        let cmdp = document.getElementsByClassName("champ_mdp_conf")[0];
                        let errmdp = document.getElementById("err-mdp-diff");
                ...
                <div class="infos-persos">
                    ...
                    <div class="bloc-prenom">
                        <label>Prénom</label>
                        <input class="champ_nom" type="text" name="prenom" value="<?php
                    ...
                    <div class="bloc-nom">
                        <label>Nom</label>
                        <input class="champ_prenom" type="text" name="nom" value="<?php
                    ...
                    <div class="bloc-ddn">
                        ...
                        <input class="champ_date_naissance" type="date" name="ddn" value="<?php
                    ...
                    <div class="bloc-adresse">
                        ...
                        <input class="champ_adresse" type="text" name="adr_facturation" value="<?php if (isset($_SESSION['adr_facturation_champ'])) {
                                                                                                    echo $_SESSION['adr_facturation_champ'];
                                                                                                } ?>" required>

                        <label>Complément d'adresse</label>
                        <input class="champ_adresse" type="text" name="complementAdresse_facturation" value="<?php if (isset($_SESSION['complementAdresse_facturation_champ'])) {
                                                                                                                    echo $_SESSION['complementAdresse_facturation_champ'];
                                                                                                                } ?>">
                        <div class="bloc-flexAdresse">
                            <div>
                                <label>Ville</label>
                                <input class="champ_ville" type="text" name="ville_facturation" value="<?php if (isset($_SESSION['ville_facturation_champ'])) {
                                                                                                            echo $_SESSION['ville_facturation_champ'];
                                                                                                        } ?>">
                            </div>
                            <div>
                                <label>Code postal</label>
                                <input class="champ_codePostal" type="number" name="codePostal_facturation"
                                    value="<?php if (isset($_SESSION['codePostal_facturation_champ'])) {
                                                echo $_SESSION['codePostal_facturation_champ'];
                                            } ?>" required>
                            </div>
                        </div>

                        <label><input name="checkBox_LivraisonAdresse" id="checkBox_LivraisonAdresse" type="checkbox"
                                checked>Utiliser la même adresse pour la livraison</label>

                        <div id="bloc-LivraisonAdresse">
                            <h3>Adresse de livraison</h3>
                            <label>Adresse postale</label>
                            <input class="champ_adresse" type="text" name="adr_livraison" value="<?php if (isset($_SESSION['adr_livraison_champ'])) {
                                                                                                        echo $_SESSION['adr_livraison_champ'];
                                                                                                    } ?>">

                            <label>Complément d'adresse</label>
                            <input class="champ_adresse" type="text" name="complementAdresse_livraison" value="<?php if (isset($_SESSION['complementAdresse_livraison_champ'])) {
                                                                                                                    echo $_SESSION['complementAdresse_livraison_champ'];
                                                                                                                } ?>">

                            <div class="bloc-flexAdresse">
                                <div>
                                    <label>Ville</label>
                                    <input class="champ_ville" type="text" name="ville_livraison" value="<?php if (isset($_SESSION['ville_livraison_champ'])) {
                                                                                                                echo $_SESSION['ville_livraison_champ'];
                                                                                                            } ?>">
                                </div>

                                <div>
                                    <label>Code postal</label>
                                    <input class="champ_codePostal" type="number" name="codePostal_livraison"
                                        value="<?php if (isset($_SESSION['codePostal_livraison_champ'])) {
                                                    echo $_SESSION['codePostal_livraison_champ'];
                                                } ?>">
                                </div>
                    ...
                    <div class="bloc-question">
                        ...
                        <select id="cars" class="champ_question" name="question">
                            ...
                            $tab_question = array(
                                ...
                                "Quel était le fabricant de votre première voiture ?",
                                "Quelle était votre nourriture préférée quand vous étiez enfant ?"
                            );
                            ?>
                ...
                <label class="conditions">
                    <input type="checkbox" name="conditions" style="margin-bottom:15px" required>J'accepte les
                ...
                <p class="deja_inscrit">Déjà inscrit ?<a class="se_connecter" href="login.php">Se connecter</a></p>

                <p class="txt_prevention">En créant un compte, vous acceptez les conditions générales de vente d’alizon.
                    Veuillez consulter notre notice Protection de vos Informations Personnelles, notre notice Cookies et
    ...
    <footer>
        <script>
            ...
            let checkBoxLivraisonAdress = document.getElementById("checkBox_LivraisonAdresse");
            let blocLivraisonAdresse = document.getElementById("bloc-LivraisonAdresse");
