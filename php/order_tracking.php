    ...
    <main class="main-Compte">
        ...
        <aside class="mesInfos">
            ...
            <div class="liens_compte">
                <a class="infosClient" onClick="menu()" id="infos_personnelles_btn"
                    href="monCompte.php#infos_personnelles"><i class="fa-solid fa-user"></i>Mes infos persos</a>
                <a class="btn-commande" onClick="menu()" id="infos_commandes_btn"
                    href="monCompte.php#infos_commandes"><i class="fa-sharp fa-solid fa-cart-shopping"></i>Mes
                    commandes</a>
            </div>
            ...
            <div class="bloc_suppression">
                ...
                <script>
                    function verifDeco() {
                        let mdp = "<?php echo $client['mdp'] ?>";
                        let verif = prompt("Entrer votre mot de passe pour désactiver votre compte ");

                        if (verif == null) {
                            alert("Désactivation Annulée");
                        } else {
                            <?php include("./functions/chiffrement.php"); ?>
        ...
        <section class="block_commande">
            ...
            <div class='commandes_cours affiche'>
                <div class="commande">
                    <aside>
                        ...
                        <div class="adresse_livraison">
                            ...
                            <h3 class="bleu">
                                <?php echo $commande[0]["nom_de_rue_livraison"] . ", " . $commande[0]["ville_livraison"] . ", " . $commande[0]["code_postale_livraison"]; ?>
                            </h3>
                        ...
                        <div class="produit_commande">
                            ...
                            ?>
                                <div class="infos_produit_commande">
                                    ...
                                    <img src='<?php echo str_replace(' ', "_", $src . $commande["$i"]['images1']); ?>'
                                    ...
                                    <div class="produit_commande-description">
                                        ...
                                        <div class="rachat_compl"><a
                                                href="product.php?idProduit=<?php echo $commande[$i]['ID_Produit']; ?>">Acheter
                                                à nouveau</a></div>
                                        <div class="rachat_plus"><a
                                                href="product.php?idProduit=<?php echo $commande[$i]['ID_Produit']; ?>">+</a>
                                        </div>
                                    </div>
                ...
                <a href="monCompte.php#infos_commandes">
...
<script>
    ...
    let elem2_produit = document.getElementsByClassName("infos_produit_commande");
