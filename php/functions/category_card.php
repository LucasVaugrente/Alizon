<?php function carte_categorie($liste)
{
     ...
     * [1] => Souscategorie
     */
    $chemin = "catalog.php?categorie=" . str_replace(' ', "_", $categorie) . "&Scategorie=" . str_replace(' ', "_", $SousCategorie);
?>
    <div class="carte_categorie" onclick='location.href="<?php echo $chemin; ?>"'>
        <div class="carte_categorie--img">
            <img src="../img/catalogue/<?php echo str_replace(' ', '_', "$categorie/$SousCategorie/$SousCategorie.jpg") ?>"
