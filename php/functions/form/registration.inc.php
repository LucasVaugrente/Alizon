...
if (isset($_POST['mdp'])) {
    ...
    if (!isset($_POST['checkBox_LivraisonAdresse'])) {
        ...
        $res = inscription(
            ...
            $_POST["cmdp"],
            $_POST['reponse'],
            $_POST['adr_facturation'],
            $_POST['complementAdresse_facturation'],
            $_POST['ville_facturation'],
            $_POST['codePostal_facturation'],
            $_POST['adr_livraison'],
            $_POST['complementAdresse_livraison'],
            $_POST['ville_livraison'],
            $_POST['codePostal_livraison']
        );
    } else {
        $res = inscription(
            $_POST["email"],
    ...
    if ($res === "Erroremail") {
        ...
        header("Location: ../../registration.php?error=mdperror");
        exit;
    } else {
