...
?>
    <div class="filtre-flou">
        <section class="changement_etat-popup">
            ...
            <form action="vendeur.php" method="get">
                ...
                <input class="radio_default" type="radio" name="Change_idCom" id="Change_idCom"
                    value="<?php echo $idCom; ?>" checked>
                <input class="radio_default" type="radio" name="Change_idProd" id="Change_idProd"
                    value="<?php echo $idProd; ?>" checked>

                <input class="radio_etat" type="radio" name="etat" id="etat-suivant"
                    value="<?php echo $etatAbrev[$i + 1]; ?>">
                ...
                <div class="boutons_finalisation">
                    <button class="bouton-annuler" type="submit" name="finalisation" value="Annuler modifications">Annuler
                        modifications</button>
                    <button class="bouton-valider" type="submit" name="finalisation" value="Valider"
    ...
    <script>
        let inputElems = document.getElementsByClassName("radio_etat");
        let filtreFlou = document.querySelector(".filtre-flou"); //:not(.changement_etat-popup)
        let popup = document.getElementsByClassName("changement_etat-popup")[0];
