...
<body>
            ...
            <div class="div-panier">
                ...
                <div class="infos-panier-sticky-responsive">
                    <div class="block-nbr-prix">
                        <h2 class="titre-panier"><?php if ($nbproduit > 1) {
                                                        echo "Votre Panier ($nbproduit produits)";
                                                    } else {
                                                        echo "Votre Panier ($nbproduit produit)";
                                                    } ?></h2>
                        ...
                        <section>
                            ...
                            <article class="Produit-Panier">
                                ...
                                <div class="Produit-Global">
                                    ...
                                    <!-- Image du Produit -->
                                    <img src="<?php echo str_replace(' ', "_", "../img/catalogue/Produits/" . $listeArticle[$numArt]['id_produit'] . "/" . $listeArticle[$numArt]['images1']); ?>"
                                        alt="photo" class="photo-prod" />
                                    ...
                                    <div class="Produit-Infos">
                                        ...
                                        <div class="stockage-panier">
                                            ...
                                            <img src="../img/stock.png" alt="logo stock" title="Stock Indisponible" width="50"
                                                height="50">
                                        </div>
                                ...
                                <div class="Prix_et_Quantites_et_Suppr">
                                    ...
                                    <div class="Prix_et_Quantites_block">
                                        ...
                                        <form
                                            action="./basket.php?id_produit=<?php echo $listeArticle[$numArt]['id_produit'] ?>"
                                            method="POST">
                                            <select class="quantites-produit" onchange="this.form.submit()"
                                                name="quantiteSelect" values="<?php echo $listeArticle[$numArt]['quantite'] ?>">
                                                <?php
                                                for ($i = 0; $i <= 99; $i++) {
                                    ...
                                    <div class="Supprimer_Produit">
                                        <a class="supprimer-article"
                                            href="./basket.php?supprimerProduit=<?php echo $listeArticle[$numArt]['id_produit'] ?>">
                                            Supprimer</a>
                                    </div>
                ...
                <section>
                    ...
                    <article class="frais">
                        ...
                        <div class="logo_et_texte_livraison">
                            <img src="../img/livraison_gratuite.png" alt="Logo Livrasion Gratuite"
                                title="Livraison Gratuite" width="50" height="40">
        ...
        <?php else: ?>
            <div class="block-panierVide">
                ...
                <div class="block-texte_panierVide">
                    <img src="../img/panier_triste.png" alt="Logo Panier Triste" title="Panier triste" width="350"
                        height="300px">
                    <h2 class="texte-panierVide">Consulter le <a href="catalog.php">catalogue</a> pour trouver des idées !
                    </h2>
                </div>
            </div>
        <?php endif; ?>
    ...
    <div class="form-popup" id="popup-Form">
        <form action="basket.php" method="GET" class="form-container">
            <h2 class="message-suppr-panier">Cette action de suppression videra le panier de tous les articles
                actuellement présents. Souhaitez-vous continuer ?</h2>
    ...
    <script>
        ...
        let popUP_Vider = document.getElementById("popup-Form");
        let btn_Vider = document.querySelector(".vider-panier");
        let fond_opacity = document.querySelector(".fond_opacity");
        let btn_Vider2 = document.querySelector(".vider-panier-responsive");
