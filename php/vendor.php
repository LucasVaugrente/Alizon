...
include("functions/ChangementEtatCommande.php");
    ...
    <main class="main-vendeur">
        ...
        <section class="commandes affiche">
            ...
            <table id="myTable">
                <tr class="en-tete" id="en-tete">
                    ...
                    <th><a onclick="sortName()" href="javascript:void(0);">Client <i id="Nameicon"
                                class="fas fa-sort"></i></a></th>
                    <th><a onclick="sortDate()" href="javascript:void(0);">Date <i id="Dateicon"
                                class="fas fa-sort"></i></a></th>
                    <!--<th><a  onclick="sortEtat()" href="javascript:void(0);">Etats <i id="Etaticon" class="fas fa-sort"></i></a></th>-->
                    <th>Facturation</th>
                    <th><a onclick="sortPrice()" href="javascript:void(0);">Total <i id="priceicon"
                                class="fas fa-sort"></i></a></th>
            ...
            <?php elseif ($_GET["import"] == "unsupportedcsv") : ?>
                ...
                <div class="alert-import-csv -affiche">
                    ...
                    <div>
                        ...
                        <h3>Ce fichier csv n'est pas supporté, veuillez utiliser le fichier csv type ci-dessous pour importer un
                            catalogue.</h3>
                    </div>
        ...
        <section class="catalogue cache">
            ...
            <div class="block-ajoutCatalogue">
                ...
                <div id="drop-area">
                    <form enctype="multipart/form-data" action="insert_catalog.php" method="post">
                        <div class="input-row">
                            <input class="importCSV" type="file" name="file" id="file" accept=".csv" pattern="\.csv"
            ...
            <table id="myTable produits">
                ...
                foreach ($produits as $produit) {
                    ...
                    echo "<td>" . "<a href=product.php?idProduit=" . $produit['ID_produit'] . ">" . $produit["Nom_produit"] . "</a> </td>";
                    ...
                    <form class="form_infos_compte" method="post" action="vendeur.php">
                        ...
                        <div class="formulaire">
                            ...
                            <div class="champ_infos_persos un">
                                <label for="fname">Nom de l'entreprise<i class="fa-solid fa-lock"
                                        title="Impossible de modifier le nom de l'entreprise"></i></label>
                                <input id="fname" type="text" name="nom" readonly="readonly"
                                    title="Impossible de modifier le nom de l'entreprise"
                                    value="<?php echo $donneesVendeur[0]["Nom_vendeur"]; ?>">
                            </div>
                            ...
                            <div class="adresse">
                                ...
                                <div class="blocs">
                                    <div class="champ_infos_persos">
                                        <label for="fname">Nom de rue<i class="fa-solid fa-lock"
                                                title="Impossible de modifier le nom de rue"></i></label>
                                        <input type="text" name="rue" readonly="readonly"
                                            title="Impossible de modifier le nom de rue"
                                            value="<?php echo $donneesVendeur[0]["nom_de_rue"]; ?>">
                                    </div>

                                    <div class="champ_infos_persos">
                                        <label for="fname">Ville<i class="fa-solid fa-lock"
                                                title="Impossible de modifier la ville"></i></label>
                                        <input type="text" name="ville" readonly="readonly"
                                            title="Impossible de modifier la ville"
                                            value="<?php echo $donneesVendeur[0]["ville"]; ?>">
                                    </div>

                                    <div class="champ_infos_persos">
                                        <label for="fname">Code Postal <i class="fa-solid fa-lock"
                                                title="Impossible de modifier le code postal l'entreprise"></i></label>
                                        <input type="text" name="code_postal" readonly="readonly"
                                            title="Impossible de modifier le code postal"
                                            value="<?php echo $donneesVendeur[0]["code_postale"]; ?>">
                                    </div>
                                </div>
                            ...
                            <div class="blocs">
                                <div class="champ_infos_persos">
                                    <label for="fname">Email de l'entreprise<i class="fa-solid fa-lock"
                                    ...
                                    <input type="email" name="email" readonly="readonly"
                                        ...
                                        value="<?php echo $donneesVendeur[0]["Email"]; ?>">
                                </div>

                                <div class="champ_infos_persos">
                                    <label for="fname">TVA de l'entreprise <i class="fa-solid fa-lock"
                                            title="Impossible de modifier la TVA de l'entreprise"></i></label>
                                    <input type="text" name="tva" readonly="readonly"
                                        title="Impossible de modifier la TVA de l'entreprise"
                                        value="<?php echo $donneesVendeur[0]["TVA"]; ?>">
                                </div>

                                <div class="champ_infos_persos">
                                    <label for="fname">Siret de l'entreprise <i class="fa-solid fa-lock"
                                            title="Impossible de modifier le SIRET de l'entreprise"></i></label>
                                    <input type="text" name="Siret" readonly="readonly"
                                        title="Impossible de modifier le SIRET de l'entreprise"
                                        value="<?php echo $donneesVendeur[0]["Siret"]; ?>">
                                </div>
                            </div>

                            <div class="champ_infos_persos2">
                                <label for="fname">Présentation</label>
                                <textarea name="presentation" cols="110" rows="6"
                                    required><?php echo $donneesVendeur[0]["texte_Presentation"]; ?></textarea>
                            </div>

                            <div class="champ_infos_persos2">
                                <label for="fname">Note</label>
                                <textarea name="note" cols="110" rows="6"
                                    required><?php echo $donneesVendeur[0]["note"]; ?></textarea>
                            </div>
                        </div>
            ...
            <div class="bloc_mdp_vendeur">
                ...
                <section>
                    ...
                    <div class="motDePasse">
                        ...
                        <form class="form_mdp_compte" method="post" action="vendor.php#Mon_Compte">
...
<script src="../js/filter_orders.js"></script>
<script src="https://momentjs.com/downloads/moment.min.js"></script>
<script src="../js/filter_products_admin.js"></script>
<script src="../js/feedback_catalog.js"></script>
<script>
    function changer_etat(idCom, idProd) {
        document.location.href = ("vendor.php?idCom=" + idCom + "&idProd=" + idProd);
    }
</script>
