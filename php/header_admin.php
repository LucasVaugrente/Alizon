...
<div class='sticky-header'>
    <div class="haut_de_page_admin">
        ...
        <div class="logos">
            ...
            <a href="GestionCompte.php" class='logo_compte' id='logo_c'>
                <img src='../img/user-solid.svg' alt='Mon Compte' class='img_compte' title='Mon Compte' width='40'
                    height='40'>
    ...
    <div class="fond_jaune">
        <form class="tel" method="GET" action="catalog.php">
...
<script>
    ...
    let elem = document.getElementsByClassName("img_compte");
