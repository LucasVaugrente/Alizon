...
<body>
    ...
    <main class="main-renitialiser">
        ...
        <div class="main-renitialiser--bloc">
            ...
            <form class="champ_infos_persos" method="post"
                action="./functions/forgot.inc.php?email=<?php echo $_POST["email"]; ?>">
        ...
        <div class="main-renitialiser--bloc">
            ...
            <form class="champ_infos_persos" method="post" action="./forgot_password.php">
