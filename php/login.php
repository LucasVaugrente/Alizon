...
<body>
    ...
    <main class="main-connexion">
        ...
        <div class="form-connexion">
            ...
            <form method="post" action="./functions/formulaire/connexion.inc.php">
                <div class="formulaire">
                    ...
                    <div class="bloc_connexion_boutons">
                        ...
                        <span><a class="lien_mdp_oubli" href="./forgot_password.php">Mot de passe oublié ?</a></span>
                    </div>
            ...
            <hr>
            <!-- Lien vers Inscription -->
            <p> Se Connecter (en tant que Vendeur) ? <a href="connexion-vendeur.php"> Se connecter </a>
            <p>
        </div>
