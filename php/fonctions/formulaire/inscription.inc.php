<?php
    ...
    if(isset($_POST['mdp'])) {
        ...
        if(isset($_POST['complementAdresse_facturation'])){
            $_SESSION['complementAdresse_facturation'] = $_POST['complementAdresse_facturation'];
        }else{
        ...
        if(!isset($_POST['checkBox_LivraisonAdresse'])){
            ...
            if(isset($_POST['complementAdresse_livraison_champ'])){
                $_SESSION['complementAdresse_livraison_champ'] = $_POST['complementAdresse_livraison_champ'];
            }else{
