                        ...
                        <?php for ($i = 0; $i < $nbrProduits; $i++): ?>
                            <section class="produit_vendeur cursor">
                                <div class="infos_produit_vendeur">
                                    ...
                                    <img class='photo_min_2'
                                        src='<?php echo (str_replace(' ', "_", $src . $liste_produit_vendeur[$i]['images1'])); ?>'
                                        alt='image_produit'>
                                    <section>
                                        <div class="infos_produit1">
                                            <article>
                                                <h4 class="info_produit_bleu_vendeur">
                                                    <?php echo $liste_produit_vendeur[$i]["Nom_produit"] ?></h4>
                                            </article>
                                            <article class="vendeur_HT">
                                                <h4 class="info_produit_jaune_vendeur">prix HT : &nbsp </h4></br>
                                                <h4 class="info_produit_bleu_vendeur">
                                                    <?php echo $liste_produit_vendeur[$i]["Prix_vente_HT"] ?>€</h4>

                                            </article>
                                            <article class="vendeur_TTC">
                                                <h4 class="info_produit_jaune_vendeur">prix TTC : &nbsp</h4>
                                                <h4 class="info_produit_bleu_vendeur">
                                                    <?php echo $liste_produit_vendeur[$i]["Prix_vente_TTC"] ?>€</h4>

                                            </article>
                                        </div>
                                        <div class="infos_produit2">
                                            <article>
                                                <h5 class="info_produit_gris_vendeur">
                                                    <?php echo $liste_produit_vendeur[$i]["Description_produit"] ?></h5>
                                            </article>
                                        </div>
                                    </section>
                                </div>
...
<script>
    ...
    <?php for ($i = 0; $i < $nbrProduits; $i++): ?>
        ...
        function redirectionPageProduit<?php echo $i; ?>() {
            <?php $string = "'product.php?idProduit=" . $liste_produit_vendeur[$i]['ID_produit'] . "';" ?>
