            ...
            <form class="form-inscription" action="fonctions/formulaire/inscription.inc.php" method="post">
                ...
                <div class="formulaire">
                    ...
                    <div class="identifiants">
                        ...
                        <p id="err-mdp-diff" class="texte_erreur_co">
                        ...
                        <script>
                            function afficheSiDifférent() {
                                ...
                                if ((mdp.value != cmdp.value) && (mdp.value != "") && (cmdp.value != "") && (cmdp.value.length >= 8)) {
                                    errmdp.style.display = 'block'
                                    mdp.style.borderColor = '#CB333B';
                                    mdp.style.borderWidth = '2px';
                                    cmdp.style.borderColor = '#CB333B';
                                    cmdp.style.borderWidth = '2px';
                                }
                                else {
                                    errmdp.style.display = 'none';
                                    mdp.style.borderColor = '#D9D9D9';
                                    mdp.style.borderWidth = '1px';
                                    cmdp.style.borderColor = '#D9D9D9';
                                    cmdp.style.borderWidth = '1px';
                                }
                            }
                    ...
                    <div class="infos-persos">
                        ...
                        <div class="bloc-adresse">
                            ...
                            <input class="champ_adresse" type="text" name="adr_facturation" value="<?php if(isset($_SESSION['adr_facturation'])){echo $_SESSION['adr_facturation'];}?>" required>

                            <label>Complément d'adresse</label>
                            <input class="champ_adresse" type="text" name="complementAdresse_facturation" value="<?php if(isset($_SESSION['complementAdresse_facturation'])){echo $_SESSION['complementAdresse_facturation'];}?>">
                            <div class="bloc-flexAdresse">
                                <div>
                                    <label>Ville</label>
                                    <input class="champ_ville" type="text" name="ville_facturation" value="<?php if(isset($_SESSION['ville_facturation'])){echo $_SESSION['ville_facturation'];}?>">
                                </div>
                                <div>
                                    <label>Code postal</label>
                                    <input class="champ_codePostal" type="number" name="codePostal_facturation" value="<?php if(isset($_SESSION['codePostal_facturation'])){echo $_SESSION['codePostal_facturation'];}?>" required>
                                </div>
                            </div>
                            ...
                            <div id="bloc-LivraisonAdresse">
                                ...
                                <label>Adresse postale</label>
                                <input class="champ_adresse" type="text" name="adr_livraison" value="<?php if(isset($_SESSION['adr_livraison'])){echo $_SESSION['adr_livraison'];}?>" >
                                
                                <label>Complément d'adresse</label>
                                <input class="champ_adresse" type="text" name="complementAdresse_livraison" value="<?php if(isset($_SESSION['complementAdresse_facturation'])){echo $_SESSION['complementAdresse_facturation'];}?>">

                                <div class="bloc-flexAdresse">
                                    <div>
                                        <label>Ville</label>
                                        <input class="champ_ville" type="text" name="ville_livraison" value="<?php if(isset($_SESSION['ville_livraison'])){echo $_SESSION['ville_livraison'];}?>" >
                                    </div>

                                    <div>
                                        <label>Code postal</label>
                                        <input class="champ_codePostal" type="number" name="codePostal_livraison" value="<?php if(isset($_SESSION['codePostal_livraison'])){echo $_SESSION['codePostal_livraison'];}?>" >
                                    </div>
