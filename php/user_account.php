...
if (isset($_POST['verif_infos'])) {
    verifier_infos_mdp($_POST['email'], $_POST['pwd']);
}
...
<body>
    ...
    <main class="main-Compte">
        ...
        <aside class="mesInfos">
            ...
            <div class="bloc_nom_compte">
                ...
                <div class="nom_compte">
                    <i
                        class="fa-solid fa-user"></i><?php echo strtoupper($client['nom_client']) . " " . $client['prenom_client']; ?>
                </div>
            ...
            <div class="liens_compte">
                <a class="infosClient" id="infos_personnelles_btn" href="#infos_personnelles"><i
                        class="fa-solid fa-user"></i>Mes infos persos</a>
                <a class="btn-commande" id="infos_commandes_btn" href="#infos_commandes"><i
                        class="fa-sharp fa-solid fa-cart-shopping"></i>Mes commandes</a>
            </div>
        ...
        <div id="infos_personnelles_block" class="bloc_infos_client affiche">
                            ...
                            <div class="formulaire">
                                ...
                                <div class="champ_infos_persos">
                                    ...
                                    <input id="fname" type="text" name="nom"
                                        placeholder=<?php echo str_replace(" ", "-", $client['nom_client']); ?>>
                                </div>

                                <div class="champ_infos_persos">
                                    <label for="fname">Prénom</label>
                                    <input type="text" name="prenom"
                                        placeholder=<?php echo str_replace(" ", "-", $client['prenom_client']); ?>>
                                </div>
                                <div class="champ_infos_persos">
                                    <label for="fname">Email <i class="fa-solid fa-triangle-exclamation"
                                            style="color: red;"
                                            title="Impossible de modifier l'adresse mail"></i></label>
                                    <input type="email" name="email" readonly="readonly"
                                        title="Impossible de modifier l'adresse mail"
                                        value=<?php echo str_replace(" ", "-", $client['email']); ?>>
                                </div>

                                <div class="champ_infos_persos">
                                    <label for="fname">Date de naissance</label>
                                    <input type="date" name="DateDeNaissance"
                                        value=<?php echo str_replace(" ", "-", $client['date_de_naissance']); ?>>
                                </div>
                        ...
                        <?php foreach ($listeAdresseFacturation as $adr):
                            ...
                            <div>
                                ...
                                <form action="./monCompte.php#Mes-adresses" method="POST">
                                    ...
                                    <input name="checkbox_facturation" type="hidden"
                                        value="<?php echo $adr['adresse_facturation']; ?>">
                                </form>

                                <form action="#Mes-adresses" method="POST">
                                    <?php if (sizeof($listeAdresseFacturation) <= 1): ?>
                                        <button class="supprimer" name="SupprimmerAdresse"
                                            value="<?php echo $adr['ID_Adresse']; ?>" type='submit'
                                            title="Vous devez obligatoirement avoir une adresse de facturation minimum"
                                            disabled>Supprimer</button>
                                    <?php else: ?>
                                        <button class="supprimer" name="SupprimmerAdresse" value="SupprimmerAdresse"
            ...
            <form class="bloc_infos_persos_client ChangerAdresse" method="POST" action="monCompte.php#Mes-adresses">
                ...
                <input type="hidden" name="ID_Adresse" value="<?php if (isset($_POST['ModifierAdresse']) && isset($_POST['ID_Adresse'])) {
                                                                    echo $_POST['ID_Adresse'];
                                                                } ?>" required>

                <label>Adresse postale</label>
                <input class="champ_adresse" type="text" name="adr" value="<?php if (isset($_POST['ModifierAdresse']) && isset($_POST['adr'])) {
                                                                                echo $_POST['adr'];
                                                                            } ?>" required />

                <label>Complément d'adresse</label>
                <input class="champ_adresse" type="text" name="complementAdresse" value="<?php if (isset($_POST['ModifierAdresse']) && isset($_POST['complementAdresse'])) {
                                                                                                echo $_POST['complementAdresse'];
                                                                                            } ?>" />

                <div class="bloc-flexAdresse">
                    <div>
                        <label>Ville</label>
                        <input class="champ_ville" type="text" name="ville" value="<?php if (isset($_POST['ModifierAdresse']) && isset($_POST['ville'])) {
                                                                                        echo $_POST['ville'];
                                                                                    } ?>" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input class="champ_codePostal" type="number" name="codePostal" value=<?php if (isset($_POST['ModifierAdresse']) && isset($_POST['codePostal'])) {
                ...
                <?php if (isset($_POST['ModifierAdresse']) && isset($_POST['checkbox_facturation']) && $_POST['checkbox_facturation'] == 1 && sizeof($listeAdresseFacturation) <= 1): ?>
                    <div class="Block_checkbox_Adressefacturation_disbaled">
                        <input name="checkbox_facturation" type="checkbox" checked disabled><label>Utiliser comme adresse de
                            facturation</label> <label class="texte_erreur_adr">(Vous devez obligatoirement avoir une
                            adresse de facturation minimum)</label>
                        <input type="hidden" name="checkbox_facturation" checked>
                    <?php else: ?>
                        <div>
                            <input name="checkbox_facturation" type="checkbox" <?php if (isset($_POST['ModifierAdresse']) && isset($_POST['checkbox_facturation']) &&  $_POST['checkbox_facturation'] == 1) {
                                                                                    echo "checked";
                                                                                } ?>><label>Utiliser comme adresse de
                                facturation</label>
                        <?php endif; ?>
                        </div>
            ...
            <form class="bloc_infos_persos_client SupprimerAdresse" method="POST" action="monCompte.php#Mes-adresses">
                ...
                <input type="hidden" name="ID_Adresse" value="<?php if (isset($_POST['SupprimmerAdresse']) && isset($_POST['ID_Adresse'])) {
                                                                    echo $_POST['ID_Adresse'];
                                                                } ?>" required>
                <?php
            ...
            <script>
                let bloc_AdressesClient = document.querySelector(".AdressesClient");
                let button_Ajouter = document.querySelector(".form_infos_adresse .bloc_confirmer input");
                let button_Modifier = document.querySelectorAll(".form_infos_adresse button.modifier");
                let button_Supprimer = document.querySelectorAll(".form_infos_adresse button.supprimer");

                let bloc_ChangerAdresse = document.querySelector(".ChangerAdresse");
                let bloc_SupprimerAdresse = document.querySelector(".SupprimerAdresse");
                let button_Valider = document.querySelector(".ChangerAdresse .bloc_confirmer input.ajouter");
                let Titre_ChangerAdresse = document.querySelector(".ChangerAdresse h1");

                let champs_ChangerAdresse_adr = document.querySelector(".ChangerAdresse input[name='adr']");
                let champs_ChangerAdresse_complementAdresse = document.querySelector(
                    ".ChangerAdresse input[name='complementAdresse']");
                let champs_ChangerAdresse_ville = document.querySelector(".ChangerAdresse input[name='ville']");
                let champs_ChangerAdresse_codePostal = document.querySelector(".ChangerAdresse input[name='codePostal']");

                let button_Annuler_ChangerAdresse = document.querySelector(".ChangerAdresse a.supprimer");
                let button_Annuler_SupprimerAdresse = document.querySelector(".SupprimerAdresse a.supprimer");
                    ...
                    <div class="motDePasse">
                        ...
                        <form class="form_mdp_compte" method="post" action="monCompte.php">
                            ...
                            <div class="formulaire">
                                ...
                                <?php if (isset($_POST["VerifConfirmationMdp"])) {
                                    echo "<p>Mot de passe incohérent</p>";
                                } ?>
                                <?php if (isset($_POST["VerifAncienMdp"])) {
        ...
        <section id="infos_commandes_block" class="mesCommandes cache">
            ...
            <nav>
                <div>
                    <h2><a onClick="changeCommandes()" id="CommandesCours" href="#enCours"
                            class="no_deco bleu carter">Commandes en cours</a></h2>
                    <hr class="commande_nav_barre-cours affiche" />
                </div>
                <div>
                    <h2><a onClick="changeCommandes()" id="CommandesArch" href="#effectuees"
                            class="no_deco gris carter">Commandes archivées</a></h2>
                        ...
                        <div class="commande">
                            <aside>
                                ...
                                <div class="adresse_livraison">
                                    <h3>Livraison à </h3>
                                    <h3 class="bleu">
                                        <?php echo $laCommande["nom_de_rue_livraison"] . ", " . $laCommande["ville_livraison"] . ", " . $laCommande["code_postale_livraison"]; ?>
                                    </h3>
                                </div>
                                <div>
                                ...
                                <!-- <form class="form-recommander" action="basket.php" method="POST">
                            ...
                            <div>
                                ...
                                <form id="formSuiviCommande<?php echo $laCommande['ID_Commande']; ?>" name="suiviCommande"
                                    action="suiviCommande.php?<?php echo 'numCommande=' . $laCommande["ID_Commande"] ?>"
                                    method="POST">
                                    <input type="hidden" name="IdCommande"
                                        value=<?php echo $laCommande['ID_Commande']; ?>></label>
                                ...
                                ?>
                                    <div class="produit_commande<?php echo $laCommande['ID_Commande']; ?>">
                                        <div class="infos_produit_commande">
                                            <img src='<?php echo str_replace(' ', "_", $src . $laCommande["$i"]['images1']); ?>'
                                                alt="Image Produit" title="Image Produit" class="img_commande">
                                            <div class="produit_commande-description">
                                                <h4><?php echo $laCommande["$i"]['Nom_produit']; ?></h4>
                                                <div class="rachat_compl"><a
                                                        href="product.php?idProduit=<?php echo $laCommande[$i]['ID_Produit']; ?>">Acheter
                                                        à nouveau</a></div>
                                                <div class="rachat_plus"><a
                                                        href="product.php?idProduit=<?php echo $laCommande[$i]['ID_Produit']; ?>">+</a>
                                                </div>
                                            </div>
                                            <div>
                ...
                ?>
                        ...
                        <div class="commande">
                            <aside>
                                ...
                                <form class="form-recommander" action="basket.php" method="POST">
                                    <input class='cache' type="cache" id="commandeID<?php echo $laCommande['ID_Commande']; ?>"
                                        name="commandeID" value="<?php echo $laCommande['ID_Commande']; ?>" />

                                    <button type="submit" id="button-recommander<?php echo $laCommande['ID_Commande']; ?>"
                                        name="button-recommander">Acheter à nouveau</button>
                                </form>
                            </aside>
                            <div>
                            ...
                            <!--<div class="liste_produits_commande<?php echo $laCommande['nb']; ?>">
                                ...
                                <div class="produit_commande<?php echo $laCommande['nb']; ?>">
                                    <div class="infos_produit_commande">
                                        ...
                                        <div class="produit_commande-description">
                                            <h4><?php echo $laCommande["$i"]['Nom_produit']; ?></h4>
                                            <div class="rachat_compl"><a href="product.php?idProduit=<?php echo $laCommande[$i]['ID_Produit']; ?>">Acheter à nouveau</a></div>
                                            <div class="rachat_plus"><a href="product.php?idProduit=<?php echo $laCommande[$i]['ID_Produit']; ?>">+</a></div>
                                        </div>
                                        <div>
                                            <h3><?php echo $laCommande["$i"]['Prix_vente_TTC']; ?> €</h3>
                                            <h4>Quantité : <?php echo $laCommande[$i]['Quantite']; ?></h4>
                                    ...
                                    <aside class="produit_commande-boutons">
                                        <a href="product.php?idProduit=<?php echo $laCommande[$i]['ID_Produit']; ?>#bloc-btn-ajouter-avis">Donner un avis</a>
                                    </aside>
                                </div>
                                <?php if ($i < $laCommande['nb'] - 1) { ?>
                                <?php }
                                ...
                                ?>
                                    <div class="produit_commande<?php echo $laCommande['ID_Commande']; ?>">
                                        <div class="infos_produit_commande">
                                            ...
                                            <aside class="produit_commande-boutons">
                                                <a
                                                    href="product.php?idProduit=<?php echo $laCommande[$i]['ID_Produit']; ?>#bloc-btn-ajouter-avis">Donner
                                                    un avis</a>
                                            </aside>
                                        </div>
    ...
    <?php if ((isset($_GET['mdp_desac']))): ?>
        ...
        <?php if ($mdp == ""): ?>
            <script>
                ...
                let texte_erreur_non_saisi = document.querySelector(".texte_erreur_non_saisi");
        ...
        <?php if ($verif[0]['mdp'] == chiffrementMDP($mdp)): ?>
            ...
            <?php else: ?>
                <script>
                    let popUP_Desactive = document.getElementById("popup-Form");
                    let fond_opacity = document.querySelector(".fond_opacity");
                    let texte_erreur_imp = document.querySelector(".texte_erreur_imp");
        ...
        <?php elseif (($verif[0]['mdp'] != chiffrementMDP($mdp)) && ($mdp != "")): ?>
            <script>
                let popUP_Desactive = document.getElementById("popup-Form");
                let fond_opacity = document.querySelector(".fond_opacity");
                let texte_erreur_co = document.querySelector(".texte_erreur_co");
    ...
    <script>
        let infos_cliBtn = document.getElementById("infos_personnelles_btn");
        let infos_cli = document.getElementById("infos_personnelles_block");
        let infos_comBtn = document.getElementById("infos_commandes_btn");
        let infos_com = document.getElementById("infos_commandes_block");
        let elem_aff = document.getElementsByClassName("affiche")[0];

        let coursBtn = document.getElementById("CommandesCours");
        let barreCours = document.getElementsByClassName("commande_nav_barre-cours")[0];
        let cours = document.getElementsByClassName("commandes_cours")[0];
        let archiveBtn = document.getElementById("CommandesArch");
        let barreArch = document.getElementsByClassName("commande_nav_barre-archi")[0];
        let archive = document.getElementsByClassName("commandes_archivees")[0];
        ...
        <?php foreach ($lCommandesCours['listeCommandeTotale'] as $laCommande): ?>
            ...
            let elem_produit<?php echo $laCommande['ID_Commande']; ?> = document.getElementsByClassName(
                "liste_produits_commande<?php echo $laCommande['ID_Commande']; ?>");
            let elem2_produit<?php echo $laCommande['ID_Commande']; ?> = document.getElementsByClassName(
                "produit_commande<?php echo $laCommande['ID_Commande']; ?>");
            let clique_produit<?php echo $laCommande['ID_Commande']; ?> = document.getElementById(
                "<?php echo $laCommande['ID_Commande']; ?>");

            clique_produit<?php echo $laCommande['ID_Commande']; ?>.addEventListener("click",
                affichageBlocCommande<?php echo $laCommande['ID_Commande']; ?>)
            clique_produit<?php echo $laCommande['ID_Commande']; ?>.style.cursor = "pointer";
            let affiche<?php echo $laCommande['ID_Commande']; ?> = true;
        ...
        let popUP_Desactive = document.getElementById("popup-Form");
        let btn_Desactive = document.querySelector(".supprimer");
        let fond_opacity = document.querySelector(".fond_opacity");
