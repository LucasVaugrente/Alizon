...
/*#################### VARIABLES ####################*/
let BlockError = document.querySelector(".erreur_co");
let TypeCbPayement = document.getElementById("TypeCbPayement");
let BtnValiderPaiement = document.getElementById("BtnValiderPaiement");
// message d'erreur concernant le numéro de carte Bancaire
let TextErrorCardnumber = document.querySelector(".texte_erreur_cardnumber");

// message d'erreur concernant la date d'expiration de la carte Bancaire
let TextErrorDateCB = document.querySelector(".texte_erreur_dateCB");
...
let dateCB = document.getElementById("dateCB");
...
BtnValiderPaiement.removeAttribute('disabled');
// Nombre de caractères rentrées dans 'ccnum'(voir letiables ci-dessus) sans les '-' .
let cpt_ccnum = 0;
...
// Evenement déclanché lorsque l'on quitte le champs 'dateCB'(voir letiables ci-dessus).
