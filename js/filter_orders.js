...
function ajouterActive(ajout_bouton) {
    let bouton = document.querySelector(".filtreCommande .active");
...
function sortPrice() {
    if (priceset == 0) {
        ...
        document.getElementById("priceicon").className =
...
function sortName() {
    if (nameset == 0) {
        ...
        document.getElementById("Nameicon").className =
...
function sortDate() {
    if (dateset == 0) {
        document.getElementById("Dateicon").className =
...
function sortEtat() {
    if (etatset == 0) {
        document.getElementById("Etaticon").className =
            "fas fa-sort-amount-down-alt";
...
function sortTablePriceDecroissant() {
    ...
    while (switching) {
        ...
        for (i = 1; i < rows.length - 1; i++) {
            shouldSwitch = false;
            x = parseInt(
                rows[i].getElementsByTagName("TD")[5].getElementsByTagName("p")[0]
                    .innerHTML,
            );
            y = parseInt(
                rows[i + 1].getElementsByTagName("TD")[5].getElementsByTagName("p")[0]
                    .innerHTML,
            );
            if (x < y) {
                shouldSwitch = true;
...
function sortTableDateOldFirst() {
    ...
    while (switching) {
        ...
        for (i = 1; i < rows.length - 1; i++) {
            ...
            y = moment(
                rows[i + 1].getElementsByTagName("TD")[2].innerHTML,
                "DD/MM/YYYY",
            ).toDate();
            if (x > y) {
                shouldSwitch = true;
...
} else if (url_page.includes("#exporter-catalogue")) {
    // redirection formulaire exporter catalgue
...
function Affiche(num) {
    let elements = document.querySelectorAll("tr[id='commande" + num + "']");
...
function detailProduit(num) {
    if (detailP) {
        ...
        for (let i = 0; i < icons.length; i++) {
            icons[i].style.display = "let(--fa-display,inline-block)";
        }
...
// let categorieDatalist = document.getElementById('categorie-list');
// let categorieOptions = categorieDatalist.getElementsByTagName('option');

// let souscategorieInput = document.getElementById('souscategorie');
// let souscategorieDatalist = document.getElementById('souscategorie-list');
// let souscategorieOptions = souscategorieDatalist.getElementsByTagName('option');

// categorieInput.addEventListener('change', function() {
//   let found = false;
//   for (let i = 0; i < categorieOptions.length; i++) {
...
//   let found = false;
//   for (let i = 0; i < souscategorieOptions.length; i++) {
